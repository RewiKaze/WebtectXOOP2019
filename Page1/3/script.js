function description(i){
    ...
    if(i == 1){
        ...
        db1.style.backgroundColor = "rgb(255, 228, 225)";
        db1.style.borderLeft = ".25em solid #ff8f9f";
        db1.style.color ="rgb(68, 68, 68)";
        d2.style.display = "none";

        db2.style.backgroundColor = "rgb(255, 228, 225)";
        db2.style.borderLeft = "";
        db1.style.boxShadow = "3px 5px 15px 3px rgb(220, 178, 174) inset";
        db2.style.boxShadow = "";
        ...
        db1.style.backgroundColor = "rgb(255, 228, 225)";
        db2.style.borderLeft = ".25em solid #ff8f9f";
        db2.style.boxShadow = "3px 5px 15px 3px rgb(220, 178, 174) inset";
