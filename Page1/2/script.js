function description(i){
    ...
    if(i == 1){
        ...
        db1.style.backgroundColor = "rgb(252,227,160)";
        db1.style.borderLeft = ".25em solid rgb(244, 119, 114)";
        db1.style.color ="rgb(68, 68, 68)";
        d2.style.display = "none";

        db2.style.backgroundColor = "rgb(252,227,160)";
        db2.style.borderLeft = "";
        db1.style.boxShadow = "3px 5px 15px 3px rgb(255, 206, 76) inset";
        db2.style.boxShadow = "";
        ...
        db2.style.boxShadow = "3px 5px 15px 3px rgb(255, 206, 76) inset";
